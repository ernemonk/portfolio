...
export default function AboutSection({ bio }: Props) {
  return (
    <section id="about" className="container-max px-6 py-28 scroll-mt-24 relative isolate overflow-hidden section-glow-tl">
      ...
      <div className="pt-16 border-t border-neutral-800">
        <Heading level="h3" size="2xl" className="mb-8">
          Principles
        </Heading>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {principles.map((principle) => (
            <Card key={principle.title} variant="default">
              ...
              <p className="text-sm text-neutral-100">{principle.desc}</p>
            </Card>
          ))}
        </div>
      </div>
